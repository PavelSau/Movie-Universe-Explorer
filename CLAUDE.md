...
- Use fixed height values (`max-h-96`, `h-64`) for scrollable containers — always use viewport-relative units (`max-h-[60vh]`) so content adapts to any screen size. All UI must be adaptive and responsive
